    ...
    <section class="p-10 w-full max-w-md z-40">
      <form @submit.prevent="onSubmit()">
        ...
        <textarea
          ...
          rows="5"
          v-model="raffleCreateDto.description"
        >
        </textarea>
        <div
        ...
        >
          <myinput
            :type="'date'"
            :label="'Fecha inicio'"
            v-model="raffleCreateDto.initialDate"
            id="initialDate"
          />
          <myinput
            :type="'date'"
            :label="'Fecha fin'"
            v-model="raffleCreateDto.finalDate"
            id="finalDate"
          />
        </div>
